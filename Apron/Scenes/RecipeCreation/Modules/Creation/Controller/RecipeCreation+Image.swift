...
extension RecipeCreationViewController: RecipeCreationPlaceholderImageCellProtocol {
    func chooseImageDidTapped() {
        openMediaModal()
    }
}

extension RecipeCreationViewController: RecipeCreationImageCellProtocol {
    func editPhoto() {
        openMediaModal()
    }
