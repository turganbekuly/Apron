...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/FeatureToggle/FeatureToggle.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/HapticTouch/HapticTouch.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Protocols/Protocols.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/RemoteConfig/RemoteConfig.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SnapKit/SnapKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Storages/Storages.framework"
