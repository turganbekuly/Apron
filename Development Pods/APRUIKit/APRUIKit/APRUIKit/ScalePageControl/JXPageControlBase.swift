...
@IBDesignable open class JXPageControlBase: UIView, JXPageControlType {
    ...
    var maxIndicatorSize = CGSize(width: 2, height: 2)

    var minIndicatorSize = CGSize(width: 2, height: 2)
    ...
    func layoutContentView() {
        ...
        var xParam: CGFloat = 0
        var yParam: CGFloat = 0
        ...
        case .left:
            xParam = 0
        case .right:
            xParam = (frame.width - width)
        case .center:
            xParam = (frame.width - width) * 0.5
        }
        ...
        case .top:
            yParam = 0
        case .bottom:
            yParam = frame.height - height
        case .center:
            yParam = (frame.height - height) * 0.5
        }
