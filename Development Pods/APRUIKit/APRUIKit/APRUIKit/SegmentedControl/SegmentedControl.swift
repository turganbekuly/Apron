...
public class ScrollableSegmentedControl: UIControl {
    ...
    public var fixedSegmentWidth = true {
        didSet {
        ...
        didSet {
            if oldValue != segmentStyle {
                if let collectionView_ = collectionView {
                    ...
                    switch oldValue {
                    case .textOnly:
                        collectionView_.register(
                            nilCellClass,
                            forCellWithReuseIdentifier: CollectionViewController.textOnlyCellIdentifier
                        )
                    case .imageOnly:
                        collectionView_.register(
                            nilCellClass,
                            forCellWithReuseIdentifier: CollectionViewController.imageOnlyCellIdentifier
                        )
                    case .imageOnTop:
                        collectionView_.register(
                            nilCellClass,
                            forCellWithReuseIdentifier: CollectionViewController.imageOnTopCellIdentifier
                        )
                    case .imageOnLeft:
                        collectionView_.register(
                            nilCellClass,
                            forCellWithReuseIdentifier: CollectionViewController.imageOnLeftCellIdentifier
                        )
                    }
                    ...
                    case .textOnly:
                        collectionView_.register(
                            TextOnlySegmentCollectionViewCell.self,
                            forCellWithReuseIdentifier: CollectionViewController.textOnlyCellIdentifier
                        )
                    case .imageOnly:
                        collectionView_.register(
                            ImageOnlySegmentCollectionViewCell.self,
                            forCellWithReuseIdentifier: CollectionViewController.imageOnlyCellIdentifier
                        )
                    case .imageOnTop:
                        collectionView_.register(
                            ImageOnTopSegmentCollectionViewCell.self,
                            forCellWithReuseIdentifier: CollectionViewController.imageOnTopCellIdentifier
                        )
                    case .imageOnLeft:
                        collectionView_.register(
                            ImageOnLeftSegmentCollectionViewCell.self,
                            forCellWithReuseIdentifier: CollectionViewController.imageOnLeftCellIdentifier
                        )
                    }
    ...
    private func configureAttributedTitlesForSegment(_ segment: SegmentData) {
        ...
        if let title = segment.title {
            ...
            if highlightedAttributes != nil {
                segment.highlightedAttributedTitle = NSAttributedString(
                    string: title,
            ...
            if selectedAttributes != nil {
                ...
                if highlightedAttributes != nil {
                    segment.selectedAttributedTitle = NSAttributedString(
                        string: title,
                        attributes: highlightedAttributes!
                    )
                } else {
    ...
    private class BaseSegmentCollectionViewCell: UICollectionViewCell {
        ...
        static let defaultFont = TypographyFonts.regular14
    ...
    private class TextOnlySegmentCollectionViewCell: BaseSegmentCollectionViewCell {
            ...
            didSet {
                if isSelected {
                    ...
                    if let title = super.normalAttributedTitle {
                        ...
                        titleLabel.textColor = (contentColor == nil) ?
                        BaseSegmentCollectionViewCell.defaultTextColor : contentColor!
                    }
                }
            }
        }
        ...
        override func updateConstraints() {
            ...
            variableConstraints.append(titleLabel.leadingAnchor.constraint(
                equalTo: contentView.leadingAnchor,
                constant: BaseSegmentCollectionViewCell.textPadding
            ))
            variableConstraints.append(titleLabel.trailingAnchor.constraint(
    ...
    private class ImageOnlySegmentCollectionViewCell: BaseSegmentCollectionViewCell {
        ...
        override var contentColor: UIColor? {
            didSet {
                imageView.tintColor = (contentColor == nil) ?
                BaseSegmentCollectionViewCell.defaultTextColor : contentColor!
            }
        }
        ...
        override var isHighlighted: Bool {
            didSet {
                if isHighlighted {
                    imageView.tintColor = (selectedContentColor == nil) ?
                    BaseSegmentCollectionViewCell.defaultTextColor : selectedContentColor!
                } else {
                    imageView.tintColor = (contentColor == nil) ?
                    BaseSegmentCollectionViewCell.defaultTextColor : contentColor!
                }
        ...
        override func updateConstraints() {
            ...
            variableConstraints.append(imageView.leadingAnchor.constraint(
                greaterThanOrEqualTo: contentView.leadingAnchor,
                constant: BaseSegmentCollectionViewCell.textPadding
            ))
            variableConstraints.append(contentView.trailingAnchor.constraint(
                greaterThanOrEqualTo: imageView.trailingAnchor,
                constant: BaseSegmentCollectionViewCell.textPadding
            ))
    ...
    private class BaseImageSegmentCollectionViewCell: BaseSegmentCollectionViewCell {
        ...
        override func updateConstraints() {
            ...
            variableConstraints.append(stackView.leadingAnchor.constraint(
                greaterThanOrEqualTo: contentView.leadingAnchor,
                constant: BaseSegmentCollectionViewCell.textPadding
            ))
            variableConstraints.append(contentView.trailingAnchor.constraint(
    ...
    private class ImageOnLeftSegmentCollectionViewCell: BaseImageSegmentCollectionViewCell {
        override func configure() {
            ...
            imgFrame.size = CGSize(
                width: BaseSegmentCollectionViewCell.imageSize,
                height: BaseSegmentCollectionViewCell.imageSize
            )
