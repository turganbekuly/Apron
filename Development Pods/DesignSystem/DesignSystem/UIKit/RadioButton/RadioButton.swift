...
public class RadioButton: UIView {
    ...
    private func innerBorderIncrease() -> CABasicAnimation {
        ...
        borderWidth.beginTime      = layer._currentMediaTime
    ...
    private func innerIncreaseGroup() -> CAAnimationGroup {
        ...
        group.beginTime      = layer._currentMediaTime + 0.23
    ...
    private func innerDecreaseGroup() -> CAAnimationGroup {
        ...
        group.animations     = [bounds, cornerRadius]
        group.timingFunction = CAMediaTimingFunction(name: .easeOut)
        group.beginTime      = layer._currentMediaTime + 0.31
    ...
    private func circleBorderColor() -> CABasicAnimation {
        ...
        borderColor.beginTime      = layer._currentMediaTime + 0.28
    ...
    private func waveIncreaseGroup() -> CAAnimationGroup {
        ...
        group.animations     = [bounds, cornerRadius]
        group.timingFunction = CAMediaTimingFunction(name: .easeOut)
        group.beginTime      = layer._currentMediaTime + start
    ...
    private func waveAlphaDecrease() -> CABasicAnimation {
        ...
        opacity.beginTime      = layer._currentMediaTime + 0.26
    ...
    private func waveBorderDecrease() -> CABasicAnimation {
        ...
        borderWidth.beginTime      = layer._currentMediaTime + 0.29
    ...
    private func innerDecreaseGroupReverse(duration: Double) -> CAAnimationGroup {
        ...
        group.beginTime      = layer._currentMediaTime
    ...
    private func circleBorderColorReverse(duration: Double) -> CABasicAnimation {
        ...
        borderColor.beginTime      = layer._currentMediaTime
...
fileprivate extension CALayer {
    ...
    ///
    /// - Authors:
    ///     - Thanks to [@alexandre-g](https://github.com/alexandre-g) for opening this [issue](https://github.com/rolandleth/RadioButton/issues/6) and helping find the fix for it.
    ...
    var _currentMediaTime: CFTimeInterval {
